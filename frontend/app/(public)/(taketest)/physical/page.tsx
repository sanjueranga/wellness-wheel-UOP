...
const Physical = () => {
  ...
  const handleNext = async () => {
    try {
      // Assuming you have a form element wrapping your radio buttons
      const formElement = document.getElementById("physicalForm") as HTMLFormElement | null;

      // Check if the form is valid based on built-in browser validation
      if (formElement && !formElement.checkValidity()) {
        console.error("Please answer all questions before proceeding.");
        // You can show an error message or take any other action
        return;
      }

      setIsLoading(true);
      // Perform other actions like posting scores if needed
      // await postScore({ physical: totalScore }, user.id);
      localStorage.setItem("physicalScore", totalScore.toString());

      // Navigate to the next page
      // Assuming you are using Next.js router, you can replace the link with the appropriate navigation logic
              ...
              <div className="max-w-3xl px-6 lg:max-w-6xl">
                <div className="relative -mt-16 block lg:hidden">
                  ...
                  <p className="mt-4 leading-relaxed text-gray-500">
                    Involves the maintenance of a healthy body, good physical
                    health habits, good nutrition and exercise, and obtaining
                ...
                <div className="collapse bg-base-200 mt-10 p-5">
                  ...
                  <div className="collapse-content">
                    <h2 className="my-5 font-medium text-lg font-sans">
