...
import { socialQuestions } from "@/constants";
...
const Social = () => {
  ...
  //   await postScore({ social: totalScore }, user.id);
  // };
  ...
  const handleNext = async () => {
    try {
      ...
      localStorage.setItem("socialScore", totalScore.toString());
      // await postScore({ social: totalScore }, user.id);
    } catch (error) {
        ...
        <section className="relative flex h-32 items-end bg-gray-900 lg:col-span-5 lg:h-full xl:col-span-4">
          ...
          <div className="hidden lg:relative lg:block lg:p-12">
            ...
            <p className="mt-4 leading-relaxed text-white/90">
              ...
              valued life activities that build and maintain my Social wellness)
            </p>
          </div>
        </section>
            ...
            <div className="card bg-base-100 shadow-xl">
              <div className="card-body">
                ...
                <label htmlFor="">
                  ...
                  and valued life activities that build and maintain my Social
                  wellness)
                </label>
                <input
                  type="text"
